 ...
 * @author alberto
 */
public class EditarEncomiendaController extends VBox {
    ...
    public EditarEncomiendaController(Encomienda enc){
        this.enc = enc;
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/resources/EditarEncomienda.fxml"));
